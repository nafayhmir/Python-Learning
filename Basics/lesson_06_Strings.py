...
name=Nafayh # pyright: ignore[reportUndefinedVariable]
degree="BS-EE"
...
#now 
print("Welcome",name[0:6],degree) #the numbers given will be used
...
#Omitting Values
#we can commit values
name="Nafayh"
print(name[2:]) # will print Nafayh
